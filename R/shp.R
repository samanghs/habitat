...
#' @details This function reads a shapefile from the specified path and prepares it for compatibility with raster operations by aligning its CRS and extent.
#' @examples
#' # Example usage
#'
#'
...
#' shapefile_data <- load_shapefile(shapefile_path)
#'
